...
<div id="container">
  ...
  <div id="navigation">
    ...
    <li><a href="download.php" title="" class="current">Download</a></li>
    ...
    <div id="content">
    	<div id="genURLForm">
      	<p><strong>Enter your download links here</strong></p>
        <form>
        <textarea id="urls" rows='10' cols='50'></textarea><br>
        <input type="button" value="generateLinks" onClick="test(<?php print "$uname"; ?>)">
        </form>
        </div>
        <div id="genURL">
        </div>
